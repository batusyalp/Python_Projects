...
while True:
    try:
        cikis_Tarihi = input("\nÇıkış tarihini gün(sayı ile) , ay(uzun hali,ingilizce) , yıl(uzun hali) biçiminde alınız. "
        ...
        if gun <= 365:
            print('Aracınızın 1.bakım zamanı')
            break
        elif 365 <= gun and gun <= 365 * 2:
            print('Aracınızın 2.bakım zamanı')
            break
        elif 365 * 2 <= gun and gun <= 365 * 3:
            print('Aracınızın 3.bakım zamanı')
            break
        elif 365 * 3 <= gun and gun <= 365 * 4:
            print('Aracınızın 4.bakım zamanı')
            break
        elif 365 * 4 <= gun and gun <= 365 * 5:
            print('Aracınızın 5.bakım zamanı')
            break
        else:
